  ...
  return (
    <div ref={ref} className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden max-w-md mx-auto">
      ...
      <div className="p-4 space-y-4 bg-gray-50 min-h-[300px]">
        ...
        {/* Typing indicator — always in DOM to avoid height shift */}
        <div className={`flex justify-start transition-opacity duration-300 ${showTyping ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
