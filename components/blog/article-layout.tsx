...
export function ArticleLayout({ meta, lang, dictionary, previous, next, children }: ArticleLayoutProps) {
  const isFr = lang === "fr"
  const categoryLabel =
          ...
          <div className="order-1 lg:order-2">
            <ScrollReveal>
              <div
                ...
                className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-[#0d47a1] prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-[#0d47a1] prose-blockquote:text-gray-600 prose-strong:text-gray-900 prose-li:text-gray-700"
              >
                {children}
              </div>
            </ScrollReveal>
