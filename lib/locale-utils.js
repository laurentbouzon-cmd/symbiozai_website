 ...
 * @returns {Object} - Localized text for the specified locale
 */
export function getLocaleText(locale) {
  const localizations = {
    en: {
      title: "SymbiozAI — The headless AI CRM. Operated by your AI agent via MCP.",
      subtitle: "The headless AI CRM. Operated by your AI agent via MCP.",
      description:
    ...
    fr: {
      title: "SymbiozAI — Le CRM headless piloté par votre agent IA via MCP.",
      subtitle: "Le CRM headless piloté par votre agent IA via MCP.",
      description:
