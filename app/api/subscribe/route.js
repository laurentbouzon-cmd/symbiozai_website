...
function buildEmailHtml(email, lang) {
  ...
  const content = {
    ...
    en: {
      ...
      earlyLabel: "Early Adopter",
      earlyText: `You're an <span style="color: #ffffff; font-weight: 600;">early adopter</span>. Concretely: priority access to the product, direct influence on what we build, and early adopter pricing at launch.`,
