...
export default function ApiTestNotion({ params }) {
  const [results, setResults] = useState({})
  const [loading, setLoading] = useState(true)

  const apiEndpoints = ["/api/notion-check", "/api/notion-import", "/api/notion-minimal", "/api/notion-env"]
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Notion API Test</h1>
